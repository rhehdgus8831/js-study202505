(function () {
    ...
    function deleteTodo(targetId) {
        ...
        // state.todos = state.todos.filter(todo => todo.id !== targetId); 한줄로 줄일 수 있음
        // 리랜더링
        render();
    }
    ...
    function toggleTodo(targetId) {
        ...
        // 클릭한 타겟의 아이다가 일치하는 상태배열의 객체를 탐색
